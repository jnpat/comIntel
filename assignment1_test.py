...
class NN(object):
  ...
  def backward(self, x, e):
    ...
    # print('deltaW'+ str(self.deltaW))
    #save weight
    # print(self.deltaW)
    # print('deltaB'+ str(self.deltaB))
    # if self.deltaWP == 0:
    #   self.deltaWP = self.deltaW.copy()
    #   # print(self.deltaWP)
    # self.weight = self.weight + self.momentumRate * (self.deltaW - self.deltaWP) + self.deltaW
    # # # self.weightBias = self.weightBias + self.momentumRate * (self.deltaB - self.deltaBP) + self.deltaB
    # self.deltaWP = self.deltaW.copy()
    # print(self.weight)
    # print(self.weightBias)
